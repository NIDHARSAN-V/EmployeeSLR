        ...
        <div className="flex items-start justify-between gap-2 mb-3">
          <div>
            <div className="flex items-center gap-2 mb-1.5">
              <span className="text-[10px] text-slate-600 tracking-widest uppercase">{ticket.kind}</span>
              <span className="text-[10px] text-slate-700">·</span>
              <span className="text-[10px] text-slate-600 tracking-wider">#{ticket.refId}</span>
            </div>
            <h3 className="text-sm font-medium text-slate-200 leading-snug">{ticket.request_type}</h3>
          </div>
